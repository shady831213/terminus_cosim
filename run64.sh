...
TESTNAME=$TESTNAME RISCV_TOOLCHAIN_PREFIX=riscv64-unknown-elf- cargo build -p terminus_cosim_tests  --features="terminus_cosim/ptr64"  -Zunstable-options --release --out-dir target/$TESTNAME --bin $TESTNAME --target riscv64gc-unknown-none-elf
